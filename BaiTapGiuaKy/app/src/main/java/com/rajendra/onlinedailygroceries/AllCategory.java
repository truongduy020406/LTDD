...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(9, R.drawable.ic_egg));
        allCategoryModelList.add(new AllCategoryModel(10, R.drawable.ic_dairy));
        allCategoryModelList.add(new AllCategoryModel(11, R.drawable.ic_juce));
        allCategoryModelList.add(new AllCategoryModel(12, R.drawable.ic_juce));
        allCategoryModelList.add(new AllCategoryModel(13, R.drawable.ic_juce));
